        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm p-5 h-full">
                    ...
                    <!-- 分页控件：根据当前标签显示对应分页 -->
                    <?php
                    $total_pages = $active_tab == 'pending' ? $total_pending_pages : ($active_tab == 'my-grabbed' ? $total_my_grabbed_pages : $total_appeal_pages);
                    if ($total_pages > 1): ?>
                        ...
                        <div class="flex flex-col md:flex-row md:items-start md:space-x-6">
                            ...
                            <div class="w-full md:w-2/3 mb-6 md:mb-0">
                                <div class="photo-frame">
                                    ...
                                    <canvas id="histogramCanvas" width="512" height="150"
                                        class="mt-4 w-full border rounded bg-black"></canvas>
                                </div>
                                <script>
                                    document.addEventListener('DOMContentLoaded', () => {
                                        ...
                                        function generateHistogram() {
                                            ...
                                            drawRGBHistogram(rHist, gHist, bHist);
                                        }

                                        function drawRGBHistogram(r, g, b) {
                                        ...
                                        /* 正常加载 */
                                        img.addEventListener('load', generateHistogram);

                                        /* 动态换图 */
                                        new MutationObserver(generateHistogram)
                                            .observe(img, {
                                                attributes: true,
                                                attributeFilter: ['src']
                                            });
