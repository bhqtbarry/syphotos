        ...
        elseif (isset($_POST['delete_photo'])) {
            try {
                ...
                if (!$photo) {
                    ...
                    $file_patho = "uploads/o/" . $photo['filename'];
                    $file_exists = file_exists($file_path);
                    $fileo_exists = file_exists($file_patho);
                    ...
                    if ($fileo_exists && !unlink($file_patho)) {
                        throw new Exception("文件删除失败，请手动检查uploads目录权限");
                    }
                ...
                <?php foreach ($photos as $photo): ?>
                    <div class="photo-item">
                        ...
                        <div class="photo-info">
                            ...
                            <h3 class="photo-title"><?php echo htmlspecialchars($photo['score']); ?>分</h3>
